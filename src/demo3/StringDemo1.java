...
public class StringDemo1 {
	...
	public static void main(String[] args) {
		...
		// 다른방법 ---> System.out.println("결과1 : " + str1.toUpperCase());
		 ...
		 */
		String name1 = new String("이순신");		// 1,2의 객체가 따로 만들어짐
		String name2 = new String("이순신");
		String name3 = "이순신";					// 3,4가 같은 객체를 바라봄
		String name4 = "이순신";
		...
		// String substring(int beginIndex) : beginIndex에서 끝까지 잘라낸 새로운 문자열을 반환한다.
		// String substring(int beginIndex, int endIndex) : beginIndex에서 EndIndex앞까지 잘라낸 새로운 문자열을 반환한다.
		// 주민등록번호에서 앞자리만 필요할때
		String str4 = "이것이 자바다";
		...
		String str5 = "이것이 자바다";
		boolean result7 = str5.contains("파이썬");
		...
		// String[] split(String str) : 지정된 문자로 문자열을 잘라서 배열에 담아서 반환한다.
		// csv 파일에서 많이쓰임
