...
public class FormaterDemo1 {
	...
	public static void main(String[] args) {
		...
		String pattern1 = "yyyy";									// 2019
		String pattern2 = "yyyy-MM-dd";								// 2019-03-19
		String pattern3 = "yyyy.MM.dd HH:mm:ss";					// 2019.03.19 16:49:32
		String pattern4 = "yyyy년 M월 d일 EEEE a h시 m분 s초";		// 2019년 3월 19일 화요일 오후 4시 50분 51초
		...
		//		Date -> "오후 4시 37분 16초"		패턴 : "a h시 m분 s초"
